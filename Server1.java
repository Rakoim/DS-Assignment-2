/* Server1.java
This file initializes Server 1 for the distributed MD5 hash cracking system. 
...
Usage:
- Run this class to start Server 1.
...
// Server 1 for binding the remote object (CrackPass) to the registry
